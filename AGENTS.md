...
- `.claude/skills/`, `.claude/agents/` — the course's skills and agents (for Claude Code)
- `.agents/skills/`, `.agents/agents/` — identical copy for Codex / Antigravity and other AGENTS.md-based tools
